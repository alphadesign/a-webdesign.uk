<x-admin.layout>
    <x-admin.breadcrumb title='Testimonials Edit' :links="[
    ...
    <form method="POST" action="{{ route('admin.testimonials.update', [$testimonial]) }}" class="card shadow-sm"
        ...
        <div class="card-body table-responsive">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="rating" placeholder="Rating from 0 to 5"
                            value="{{ $testimonial->rating }}" min="1" max="5">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="content" rows="3" placeholder="Write your content"
