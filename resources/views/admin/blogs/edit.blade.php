<x-admin.layout>
    <x-admin.breadcrumb title='Edit Blog' :links="[
            ...
            <form action="{{ route('admin.blogs.update', [$blog]) }}" method="POST"
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="blog_category_id" class="form-control" required>
                                    ...
                                    <option value="{{ $blogCategory->id }}" {{ ($blog?->blog_category_id==$blogCategory->
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="sub_title" class="form-control" id="sub_title" cols="30"
                            rows="3">{{ $blog?->sub_title }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="d-flex">
                        <div class="mr-2">
                            <div id="main-image-preview">
                                <img src="{{ $blog->image() }}" alt="image" width="70"
                    ...
                    <div class="d-flex">
                        <div class="mr-2">
                            <div id="cover-image-preview">
                                <img src="{{ $blog->imageThumb() }}" alt="image" width="70"
                                class="rounded-circle img-thumbnail">
                            </div>
                        </div>
                        <div class="form-group flex-fill">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_title" class="form-control" id="meta_title" cols="30" rows="2">{{ $blog?->meta_title }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="meta_keyword">Meta Keyword</label>
                        <textarea name="meta_keyword" class="form-control" id="meta_keyword" cols="30"
                            rows="3">{{ $blog?->meta_keyword }}</textarea>
                    </div>
                    <div class="form-group">
