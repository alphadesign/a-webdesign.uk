<x-admin.layout>
    <x-admin.breadcrumb title='Create Blog' :links="[
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.blogs.store') }}" method="POST" class="card shadow-sm"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="blog_category_id" class="form-control" required>
                                    ...
                                    <option value="{{ $blogCategory->id }}" {{ (old('blog_category_id')==$blogCategory->
